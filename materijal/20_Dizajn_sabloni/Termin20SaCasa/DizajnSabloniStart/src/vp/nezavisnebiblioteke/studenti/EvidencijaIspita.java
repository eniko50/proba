...
import vp.nezavisnebiblioteke.komande.DodajStudenta;
import vp.nezavisnebiblioteke.komande.Komanda;
...
public class EvidencijaIspita {
	...
	private static EvidencijaIspita instance = new EvidencijaIspita();
	
	private Stack<Komanda> komande = new Stack<>();  
	
	private EvidencijaIspita() {}
	
	public static EvidencijaIspita getInstance() {
		return instance;
	}
	...
	public void dodajStudenta() {
		DodajStudenta komanda = new DodajStudenta(studenti);
	...
	public void ponistiPoslednjuAkciju() {
		if (komande.isEmpty()) {
			return;
		}
		Komanda poslednjaKomanda = komande.pop();
		poslednjaKomanda.ponisti();
	}
}
