...
public class Aplikacija {
	...
	public static void main(String[] args) {
		...
		EvidencijaIspita evidencija = EvidencijaIspita.getInstance();
		...
		do {
			...
			prikaziMeni();
			System.out.println("\nUnesite opciju: ");
			String opcijaTekst = evidencija.unesi();
			...
			case 12:
				...
				break;
			case 13:
				evidencija.ponistiPoslednjuAkciju();
				break;
			case 14:
	...
	private static void prikaziMeni() {
		...
		System.out.println("13. Ponisti poslednju akciju");
