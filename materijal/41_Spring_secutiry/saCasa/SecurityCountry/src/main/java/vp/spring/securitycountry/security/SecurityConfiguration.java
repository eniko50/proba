package vp.spring.securitycountry.security;
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		httpSecurity
			...
			.authorizeRequests() // bez logovanja dostupni samo servisi login
				.anyRequest().permitAll(); // Ako hocete samo preko @PreAuthorize 
//				.antMatchers("/api/login").permitAll()
//				.antMatchers(HttpMethod.DELETE).hasAuthority("ADMIN")
//				.antMatchers(HttpMethod.POST).hasAnyAuthority("ADMIN", "CREATOR")
//				.anyRequest().hasRole("ROLE"); // za ostale akcije se mora biti ulogovan
