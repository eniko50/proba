...
var MainComponent = /** @class */ (function () {
    ...
    MainComponent.prototype.save = function (newRecord) {
        ...
        this.http.post('/api/records', newRecord, { headers: headers }).subscribe(function (res) {
            _this.loadData();
        });
    };
...
module.exports = __webpack_require__(/*! /Users/nikolalukic/workspace/predavanja/VP04_2018/56_Angular_bootstrap/primeri/primer1/record-store/client/src/main.ts */"./src/main.ts");
