package vp.spring.reststudents.repository;
...
public class ExamRepository {
	...
	public ExamRepository(StudentRepository studentRepository, CourseRepository courseRepository) throws IOException {
		...
		// sacuvamo injektovane repozitorijume u atribut jer ce trebati u drugim metodama
	...
	public Exam save(Exam exam) {
		...
		// preko id-a uvezemo ispit sa odgovarajucim studentom i predmetom iz spiska studenata i predmeta
		exam.setStudent(studentRepository.findOne(exam.getStudent().getId()));
		exam.setCourse(courseRepository.findOne(exam.getCourse().getId()));
		exams.add(exam);
		return exam;
	}
