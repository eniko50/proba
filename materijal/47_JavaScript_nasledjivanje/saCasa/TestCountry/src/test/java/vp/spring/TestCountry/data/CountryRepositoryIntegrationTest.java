...
public class CountryRepositoryIntegrationTest {
	...
	public void testFindByNameContainsIgnoreCase() {
		List<Country> countries = countryRepository
				.findByNameContainsIgnoreCase("ita");
	...
	public void testFindByNameContainsOrPopulationGreaterThan() {
		List<Country> countries = countryRepository
			.findByNameContainsOrPopulationGreaterThan("Ser", 999999999);
        ...
        countries = countryRepository
        		.findByNameContainsOrPopulationGreaterThan("asdgfasdf", 65000000);
        
        assertEquals(1, countries.size());
        assertEquals("France", countries.get(0).getName());
        assertEquals(66810000, countries.get(0).getPopulation());
	}
