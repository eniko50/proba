package vp.generickeklase.ocenjivanje;
...
public class EvidencijaOcenjivanja {
	...
	private static ArrayList<Student> preuzmiPoProseku() {
	...
	private static void pronalazenjeStudenataPoProseku(){
		// izaberemo studenta kojem brisemo ispit
		ArrayList<Student> studentiSaProsekom = preuzmiPoProseku();
